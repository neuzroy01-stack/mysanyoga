...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book vehicles, invitations, photography, catering, sweets and decor for weddings, parties & ceremonies — one cinematic platform, WhatsApp-fast bookings." },
      { name: "author", content: "MySanyoga" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen bg-radial-gold text-foreground">
        <SiteHeader />
